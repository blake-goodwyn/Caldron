...
prompts_dict = {
    ...
    "Tavily": {
        ...
        Make sure all URLs are added to the Pot for further examination by the Sleuth. Once all URLs have been identified, complete the task.
        """,
    ...
    "Sleuth": {
        ...
        You MUST use the scrape_recipe_info tool on URLs in the Pot given to you. You will then use generate_recipe with that information. Esnure that you have examined all recipe URLs identified before proceeding. Once all recipes have been assessed, complete the task.
        """,
