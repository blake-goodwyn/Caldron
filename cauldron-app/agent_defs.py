...
prompts_dict = {
    ...
    "KnowItAll": {
        ...
        "tools": [get_foundational_recipe, get_graph, get_recipe, suggest_ingredient_substitution, suggest_recipe_completion, get_ingredient_affinity],
    },
    "Spinnaret": {
        "type": "agent",
        "label": "Dev\nTracker",
